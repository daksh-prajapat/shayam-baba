      ...
      <div className="popup-box">
        ...
        <div className="popup-header">
          <div className="popup-header-left">
            <div className="popup-lotus-wrap"><GiLotus className="popup-lotus" /></div>
            <div>
              <h2 className="hindi-text">जय श्री श्याम 🙏</h2>
              <p className="hindi-text">प्रसाद, भोग, पूजा — Online बुकिंग करें</p>
            </div>
          </div>
          <button className="popup-close" onClick={onClose} aria-label="बंद करें"><FiX /></button>
        </div>

        {!submitted ? (
          <div className="popup-body">
            <div className="popup-quick">
              <a href="tel:9929975116" className="pq-call"><FiPhone /> <span>9929975116</span></a>
              <a href="https://wa.me/919929975116?text=नमस्ते! बुकिंग करनी है।"
            ...
            <form className="popup-form" onSubmit={handleSubmit}>
              <div className="pf-row">
                <div className="pf-field">
                  <div className="pf-input-wrap">
                    ...
                    <input type="text" placeholder="आपका नाम *" value={form.name}
                ...
                <div className="pf-field">
                  <div className="pf-input-wrap">
                    ...
                    <input type="tel" placeholder="मोबाइल नंबर *" value={form.phone}
              ...
              <div className="pf-field">
                <select className="pf-select" value={form.service}
              ...
              <div className="pf-field">
                <div className="pf-input-wrap">
                  ...
                  <textarea placeholder="संदेश..." value={form.message}
            ...
            <p className="popup-skip hindi-text" onClick={onClose}>अभी नहीं — बाद में करूंगा/करूंगी</p>
          </div>
        ) : (
          <div className="popup-success">
            ...
            <button className="pf-submit hindi-text" onClick={onClose}>ठीक है — बंद करें</button>
          </div>
        )}
      </div>
    </div>
