...
const faqs = [
  { q: 'भंडारे की बुकिंग कैसे करें?', a: 'Call या WhatsApp पर संपर्क करें: 9051858687। हम आपको पूरी जानकारी और Quotation देंगे।' },
    ...
    <div className="bhandara-page">
      ...
      <div className="bhandara-hero">
        ...
        <div className="container bhandara-hero-content">
          ...
          <div className="bhandara-hero-btns">
            <a href="tel:9051858687" className="bhandara-call-btn"><FiPhone /> 9051858687</a>
            <a href="https://wa.me/919051858687?text=भंडारा बुकिंग करनी है" target="_blank" rel="noopener noreferrer" className="bhandara-wa-btn">
      ...
      <div className="bhandara-info-strip">
        <div className="container">
          <p className="hindi-text">🍽️ शुद्ध सात्विक भोजन • अनुभवी रसोइये • सम्पूर्ण व्यवस्था • Call: <a href="tel:9051858687">9051858687</a></p>
        </div>
      </div>
      ...
      <div className="container bhandara-container">
            ...
            {bhandaraList.map(pkg => (
              <div key={pkg.id} className={`bhandara-table-row ${pkg.special ? 'bhandara-table-special' : ''}`}>
                ...
                <button className="bhandara-table-btn" onClick={() =>
                  window.open(`https://wa.me/919051858687?text=${encodeURIComponent(`भंडारा बुकिंग — ${pkg.name}`)}`, '_blank')
                }>
                  <FaWhatsapp />
                </button>
              </div>
              ...
              {!customDone ? (
                <form className="bhandara-custom-form" onSubmit={handleCustomBook}>
                  ...
                  <div className="bhandara-custom-actions">
                    ...
                    <a href="tel:9051858687" className="bhandara-custom-call-btn"><FiPhone /> Call करें</a>
                  </div>
                </form>
              ) : (
        ...
        <div className="bhandara-cta-box">
          ...
          <div className="bhandara-cta-btns">
            <a href="tel:9051858687" className="bhandara-cta-call"><FiPhone /> 9051858687</a>
            <a href="https://wa.me/919051858687?text=भंडारा बुकिंग करनी है" className="bhandara-cta-wa" target="_blank" rel="noopener noreferrer">
