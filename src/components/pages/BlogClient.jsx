          ...
          <div className="post-full-card card">
            ...
            <div className="post-contact-cta">
              ...
              <div className="pcc-btns">
                <a href="tel:9051858687" className="pcc-call"><FiPhone /> 9051858687</a>
                <a href="https://wa.me/919051858687?text=नमस्ते! जानकारी चाहिए।" className="pcc-wa" target="_blank" rel="noopener noreferrer">
      ...
      <div className="container" style={{ padding: '50px 20px' }}>
        ...
        <div className="blog-contact-banner">
          ...
          <div className="bcb-btns">
            <a href="tel:9051858687" className="bcb-call"><FiPhone /> 9051858687</a>
            <a href="https://wa.me/919051858687?text=नमस्ते! जानकारी चाहिए।" className="bcb-wa" target="_blank" rel="noopener noreferrer">
