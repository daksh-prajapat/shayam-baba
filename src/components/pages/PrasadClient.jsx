    ...
    <div className="prasad-page-v2">
      ...
      <div className="prasad-hero-v2">
        ...
        <div className="container prasad-hero-content-v2">
          ...
          <div className="prasad-hero-actions">
            <a href="tel:9051858687" className="prasad-hero-call hindi-text"><FiPhone /> 9051858687 पर Call करें</a>
            <a href="https://wa.me/919051858687?text=प्रसाद बुकिंग करनी है" className="prasad-hero-wa" target="_blank" rel="noopener noreferrer">
      ...
      <div className="prasad-info-banner">
        <div className="container">
          <p className="hindi-text">📌 <strong>घर बैठे</strong> प्रसाद चढ़वाएं — किसी भी प्रसाद पर क्लिक करें और बुकिंग करें: <a href="tel:9051858687">9051858687</a></p>
        </div>
      </div>
              ...
              <div className="prasad-table-box">
                ...
                {prasadList.map(pkg => (
                  <div key={pkg.id} className={`prasad-table-row ${pkg.special ? 'prasad-table-special' : ''}`}>
                    ...
                    <button className="prasad-table-btn" onClick={() => window.open(`https://wa.me/919051858687?text=प्रसाद बुकिंग — ${pkg.name} ₹${pkg.price}`, '_blank')}>
                      <FaWhatsapp />
                    </button>
                  </div>
                ))}
                  ...
                  {!customDone ? (
                    <form className="prasad-custom-form" onSubmit={handleCustomBook}>
                      ...
                      <div className="prasad-custom-actions">
                        ...
                        <a href="tel:9051858687" className="prasad-custom-call"><FiPhone /> Call करें</a>
                      </div>
                    </form>
                  ) : (
        ...
        {activeTab === 'booking' && (
          <div className="prasad-booking-section">
            ...
            <div className="booking-contact-sidebar">
              <div className="card contact-card-v2"><h4 className="hindi-text">📞 Call करें</h4><a href="tel:9051858687" className="contact-big-call"><FiPhone /> 9051858687</a></div>
              <div className="card contact-card-v2"><h4 className="hindi-text">💬 WhatsApp</h4><a href="https://wa.me/919051858687" className="contact-big-wa" target="_blank" rel="noopener noreferrer"><FaWhatsapp /> WhatsApp</a></div>
