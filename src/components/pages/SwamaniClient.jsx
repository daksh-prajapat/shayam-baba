      ...
      <div className="swamani-hero">
        ...
        <div className="container swamani-hero-content">
          ...
          <div className="swamani-hero-btns">
            <a href="tel:9051858687" className="sh-call-btn"><FiPhone /> 9051858687</a>
            <a href="https://wa.me/919051858687?text=स्वामणी बुकिंग करनी है" target="_blank" rel="noopener noreferrer" className="sh-wa-btn">
      ...
      <div className="container swamani-container">
            ...
            >
              ...
              <div className="swamani-card-actions">
                ...
                <button
                  ...
                  onClick={e => { e.preventDefault(); e.stopPropagation(); window.location.href = 'tel:9051858687' }}
                  aria-label="Call">
                  <FiPhone />
                </button>
              </div>
              ...
              {!customDone ? (
                <form className="swamani-custom-form" onSubmit={handleCustomBook}>
                  ...
                  <div className="swamani-custom-actions">
                    ...
                    <a href="tel:9051858687" className="swamani-custom-call-btn">
                      <FiPhone /> Call करें
                    </a>
                  </div>
                </form>
        ...
        <div className="swamani-cta-box">
          ...
          <div className="swamani-cta-btns">
            <a href="tel:9051858687" className="cta-call"><FiPhone /> 9051858687</a>
            <a href="https://wa.me/919051858687?text=स्वामणी भोग बुकिंग करनी है" className="cta-wa"
