        ...
        <div className="pd-main-grid">
          ...
          <div className="pd-left">
            ...
            <div className="card pd-meta-card">
              ...
              <div className="pd-meta-row">
                ...
                <a href="tel:9051858687" className="pd-meta-link">9051858687</a>
              </div>
            </div>
          </div>
          ...
          <div className="pd-right">
            <div className="pd-booking-card card">
              ...
              {!receipt ? (
                <div className="pd-form">
                  ...
                  <a href="tel:9051858687" className="pd-call-btn">
            ...
            <div className="card pd-quick-contact">
              ...
              <a href="tel:9051858687" className="pd-qc-call"><FiPhone /> 9051858687</a>
              <a href={`https://wa.me/919051858687?text=${encodeURIComponent(`प्रसाद बुकिंग — ${item.name}`)}`}
