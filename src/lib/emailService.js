...
<div class="wrap">
  ...
  <div class="body">
    ...
    <div class="cta">
      <a href="https://wa.me/919929975116?text=Booking ID: ${booking.bookingId}">WhatsApp पर सम्पर्क करें</a>
    </div>
    <p style="color:#aaa;font-size:0.82rem;margin-top:20px;text-align:center">
      किसी भी सवाल के लिए Call करें: <a href="tel:9929975116" style="color:#D4A017">9929975116</a>
    </p>
  </div>
  <div class="footer">
